...
public class ShopService extends BaseService {
    ...
    public ShopDTO queryById(Long shopId) {
        ...
        shopDTO.setPersonalCertificate(userRemoteService.queryRealnameAuthStatus(shop.getUserId()));
        shopDTO.setEnterpriseCertification(userRemoteService.queryEnterpriseAuthStatus(shop.getUserId()));
        shopDTO.setFieldCertification(userRemoteService.querySiteAuthStatus(shop.getUserId()));

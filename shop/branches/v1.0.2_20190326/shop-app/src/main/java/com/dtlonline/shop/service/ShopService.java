...
public class ShopService extends BaseService {
    ...
    public void saveAuditOperation(ShopAuditDTO shopAuditDTO, Long userId) {
        Boolean enterpriseAuthStatus = authRemoteService.queryEnterpriseAuthStatus(userId);
    ...
    private ShopWithStatusDTO changeShopIntoShopWithStatusDTO(Shop shop) {
        ...
        shopWithStatusDTO
                .setEnterpriseCertification(authRemoteService.queryEnterpriseAuthStatus(shop.getUserId()))
                .setPersonalCertificate(authRemoteService.queryRealnameAuthStatus(shop.getUserId()))
                .setFieldCertification(authRemoteService.querySiteAuthStatus(shop.getUserId()))

...
public class ShopController extends BaseController implements ShopRemoteService {
    ...
    public Page queryProductSupplyForListByShopId(Long shopId, Integer current, Integer size){
        return productService.queryProductSupplyForListByShopId(current,size,shopId);
    }
}

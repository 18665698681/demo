...
public class StoreGoodsRequire {
    ...
    @TableField(value = "tradeZoneAddress")
    ...
    @ApiModelProperty(value="状态 1通过 2不通过 3待审核 4下架")
    ...
    public static final String COL_REQUIRENO= "requireNo";
    ...
    public static final String COL_TRADEZONEADDRESS = "tradeZoneAddress";
    ...
    public static final String COL_STOREADDRESS = "storeAddress";

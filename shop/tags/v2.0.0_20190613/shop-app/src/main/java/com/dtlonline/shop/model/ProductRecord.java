...
public class ProductRecord extends BaseObject {
    ...
    public static final ProductSupplyDTO of(ProductRecord productRecord){
        ProductSupplyDTO productSupplyDTO = new ProductSupplyDTO();
        Optional.ofNullable(productRecord).ifPresent(record -> BeanUtils.copyProperties(productRecord,productSupplyDTO));
